                    ...
                    <table class="layui-table" lay-data="{
                        ...
                        <thead>
                            <tr>
                                ...
                                <td lay-data="{field:'position_Name'}">位置名</td>
                        ...
                        <tbody>
                            <?php
                                ...
                                if($position_Name == '') {
                                    alert('搜索欄不能為空' ,'position_List.php');
                                }
                                $sql="select * from position where position_Name = '$position_Name' order by id";
                                $result = mysqli_query($conn ,$sql);
                                if($rows=mysqli_num_rows($result) < 1) {
                                    alert('沒有檢測到該目標' ,'position_List.php');
                                }
                                if($result) {
